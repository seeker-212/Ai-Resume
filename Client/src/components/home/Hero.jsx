  ...
  return (
    <>
      <div className="min-h-screen pb-20">
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed inset-0 z-100 bg-black/40 text-black backdrop-blur flex flex-col items-center 
          justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${
        ...
        {/* Hero Section */}
        <div
          className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 
        xl:px-40 text-black"
        >
          <div
            className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-120 
          2xl:size-132 bg-indigo-300 blur-[100px] opacity-30"
          ></div>
          ...
          <div className="flex items-center mt-24">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">Used by 5,000+ users</p>
            </div>
          </div>
          ...
          <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
            ...
            <span
              className=" bg-linear-to-r from-green-700 to-green-600 bg-clip-text text-transparent 
            text-nowrap"
            >
              AI-powered{" "}
            </span>{" "}
          ...
          <p className="max-w-md text-center text-base my-7">
            Create, edit and downlaod professional resumes with AI-powered
            assitance
          </p>
