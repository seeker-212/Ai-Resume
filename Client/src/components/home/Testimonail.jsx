...
const Testimonail = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 
      rounded-full px-4 py-1"
        ...
        <Title
          ...
          description="Hear what our users says about us. We're always looking for ways to improve.
